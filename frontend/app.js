(() => {
  ...
  const DEMO_EMAIL = window.STOREFLOW_CONFIG?.demoEmail || "admin@storeflow.demo";
  const DEMO_PASSWORD = window.STOREFLOW_CONFIG?.demoPassword || "StoreFlow123!";
